package br.usjt.arqdsis.activity_lifecycle_master.util;
...
public class Utils {
    ...
    private static br.usjt.arqdsis.activity_lifecycle_master.util.StatusTracker mStatusTracker = br.usjt.arqdsis.activity_lifecycle_master.util.StatusTracker.getInstance();
